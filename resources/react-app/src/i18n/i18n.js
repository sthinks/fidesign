...
const lngEn = {
    ...
    "contact2": "- Graduated from Architecture Department of Universities",
    "contact3": "- Able to produce projects in different scales, having knowledge of material and application details",
    ...
    "contact7": "- We are looking for teammates who can speak English fluently.",
    "contact8": "We kindly ask the candidates who can keep up with the hybrid working system to send their portfolio and CV to info@fidesignoffice.com via the wetransfer link.",
    ...
    "contactExp": "If you are excited about architecture and design and intend to realize the projects you have in mind, do not hesitate to write to us.",
    "slideTitle": "Title",
    "slideDetail": "Detail",
    ...
    "ferhat2": "He studied architecture at Yıldız Technical University and graduated with a bachelor's degree in January 2019. He worked as an intern architect in many valuable architectural offices and has participated in many student and professional competitions. He has been studying for his master's degree in architectural design at Yıldız Technical University.",
    "ferhat3": "After graduation, he developed his wide range of international professional architectural experience by working on significant projects of varying scales from social housing, to masterplans, pavilions, and museums. He participated in many workshops as a participant and organizer as he attached importance to the interactive architecture environment.",
    "ferhat4": "Now, he is the founder and architect of Fi Design Office since 2021.",
    "ece1": "Restorationist and architect at Fi Design Office.",
    "ece2": "After graduating from Istanbul Bilgi University with a high honors degree in Architectural Restoration, she continued her education at Istanbul Technical University, Department of Architecture. During her undergraduate career, she worked as an assistant to Prof. Ruhi Kafescioğlu, who was working on 'Earth Building Materials'. She participated in internships and workshops both in Turkey and abroad in the fields of architecture, restoration and design.",
...
const lngTR = {
    ...
    "contact3": "- Farklı ölçeklerde proje üretebilen, malzeme ve uygulama detaylarına hakim,",
    "contact4": "- Tasarım ve görsel sunum yönü kuvvetli,",
    "contact5": "- Takım çalışmasına yatkın, analitik düşünme yetisi olan,",
    "contact6": "- AutoCAD, Sketchup ve Lumion programlarında yetkin,",
    "contact7": "- İyi derecede İngilizce bilen takım arkadaşları arıyoruz.",
    "contact8": "Hibrit çalışma sistemine ayak uydurabilecek adayların, portfolyo ve CV’lerini wetransfer linki ile info@fidesignoffice.com adresine göndermelerini rica ederiz.",
    ...
    "contactExp": "Mimariye, tasarıma dair bir heyecanınız var ve aklınızdaki projeleri hayata geçirmek niyetindeyseniz, bize yazmaktan çekinmeyin.",
    "slideTitle": "Başlık",
    "slideDetail": "Detay",
    ...
    "ferhat2": "Yıldız Teknik Üniversitesi’ndeki mimarlık eğitimini 2019’un Ocak ayında tamamladı. Lisans yıllarında pek çok kreatif ofiste çalışmış, birden fazla yarışmada ödül ve mansiyon kazanmıştır. Yüksek lisans tez çalışmasını da mimari tasarım anadalında sürdürmektedir.",
    "ferhat3": "Mezuniyetinden sonra, yurtiçinde ve yurtdışında görev aldığı sosyal konut, masterplan, pavilyon, müze gibi farklı ölçeklerde projeler ile mimari vizyonunu ve perspektifini geliştirdi. Ayrıca, atölye yürütücülüğü ve misafir öğretim üyeliği ile mimarinin ara mekanlarında üretim yapmaya devam etmektedir.",
    "ferhat4": "2021 yılında da Fi Design Office’i kurarak kurucu mimar olarak çalışmalarına devam etmektedir.",
